...
def _add_book_tab():
    ...
    with st.form("add_book_form"):
        ...
        year = col6.number_input("Publication year", min_value=0, max_value=2100, value=2024, step=1)
...
def _edit_delete_book_tab():
    ...
    with st.form("edit_book_form"):
        ...
        year = col6.number_input("Publication year", min_value=0, max_value=2100, value=book["publication_year"] or 2024, step=1)
